    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        <TouchableOpacity style={styles.header} onPress={handleProfilePress}>
          <Image source={getLevelFaceImage(level)} style={styles.profileImage} />
        ...
        <View style={styles.progressSection}>
          <View style={styles.levelContainer}>
            ...
            <View style={styles.progressContainer}>
              ...
              <TouchableOpacity onPress={toggleInfo} style={styles.questionButton}>
        ...
        <TouchableOpacity style={styles.addButton} onPress={() => navigateToChatbot(true)}>
          <Image source={ChatbotButton} style={styles.addButtonImage} />
        </TouchableOpacity>

        <CLOiRenameModal visible={isRenameModalVisible} onClose={handleRenameClose} onConfirm={handleRenameSubmit} />
      </View>
    </SafeAreaView>
  )
}
